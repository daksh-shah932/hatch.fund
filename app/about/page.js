...
const About = () => {
    return (
        <div className="container mx-auto px-8 md:px-4 py-8">
            <h1 className="text-3xl font-semibold mb-4">About HatchFund</h1>
            <p className="text-lg mb-6">
                HatchFund is a crowdfunding platform designed for creators to fund their projects with the support of their fans. It&apos;s a space where your fans can directly contribute to your creative endeavors by buying you an Egg. Unlock the potential of your fanbase and bring your projects to life.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                ...
                <div className="flex items-center mb-6">
                    <img className="w-20 h-20 rounded-full mr-4" src="/coin.gif" alt="Support Through Egg" />
                    <div>
                        <h3 className="text-xl font-semibold mb-2">Support Through Egg</h3>
                        <p>Receive support from your fans in the form of egg purchases, directly contributing to your project funding.</p>
                    </div>
                </div>
